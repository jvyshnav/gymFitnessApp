...
class Mind7 extends StatefulWidget {
  const Mind7({super.key});

  @override
  State<Mind7> createState() => _Mind7State();
}

class _Mind7State extends State<Mind7> {
  @override
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage('assets/images/mind/mind65.1.jpg'),
                        fit: BoxFit.fill)),
              ),
              SizedBox(
                height: 28,
